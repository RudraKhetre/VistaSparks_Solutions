<?php
	...
	------------------------------------------------------ */
	$receiver_email = "enrollment@novatec.co.in";
	...
	----------------------------------------------------------------------------- */	
	$redirectForm = false;
	$redirectForm_url = "../../thankyou.html";
	$redirectFormb_url = "../../contact.html";
	
	/* Powered BY
	 * You will use both your website NAME and URL
	 * By default its powered by SMARTFORMS - http://www.doptiq.com/smart-forms
	----------------------------------------------------------------------------- */
	$poweredby_name = "Spwebconnect";
	$poweredby_url = "https://spwebconnect.com";	
